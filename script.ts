...
function addDynamicEventListeners() {
  ...
  document.getElementById('addSkillBtn')?.addEventListener('click', function () {
    const additionalSkillsDiv = document.getElementById('additionalSkills') as HTMLElement;
  ...
  document.getElementById('addEducationBtn')?.addEventListener('click', function () {
    const additionalEducationDiv = document.getElementById('additionalEducation') as HTMLElement;
  ...
  document.getElementById('addExperienceBtn')?.addEventListener('click', function () {
    const additionalExperienceDiv = document.getElementById('additionalExperience') as HTMLElement;
